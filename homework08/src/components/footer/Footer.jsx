  ...
  return (
    <footer>
        <div className="top-footer">
            <div className="container">
                <div className="left-block">
                    <img src="/src/assets/img/footer-foto.png" alt="" />
                    <p className="quotes">“Vestibulum quis porttitor dui! Quisque<br/> viverra nunc mi, <span>a pulvinar purus<br/> condimentum</span>“</p>
                </div>
        ...
        <div className="bottom-footer">
            <div className="container">
                <div className="copyright">© 2022  Brand  All Rights Reserved.</div>
